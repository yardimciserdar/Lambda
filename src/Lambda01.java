...
public class Lambda01 {
    ...
    public static void printElFunctional1(List<Integer> sayi) {
        sayi.stream().forEach(System.out::print);//method reference--> System.out yapısında(kütüphanesinde)  print methodu refere et
        // bu action task'deki aynı satıra  ve bosluk ile yazmayı karşılmaz bunun için
    ...
    public static void printCiftOtzBykFunctional(List<Integer> sayi){
       sayi.
               stream().
               filter(t -> t % 2 == 0  || t > 34   ).
               // filter(lambdaTutorial.Lambda01::ciftBul).//method ref. Bunlar olmaz
               // filter(t -> t > 34).//lambda exp. Bunlar olamaz çünkü veya da bunlar mantık hatası veriyor.
               forEach(Lambda01::yazdir);
    }
